...
server.registerTool('bindery_setup_ai_files', {
    ...
    inputSchema: {
        ...
        skills:    z.array(z.string()).optional().describe('Which Claude skills to generate: review, brainstorm, memory, translate, translation-review, status, continuity, read-aloud, read-in, proof-read, plan-beats, character-setup, image-style, chapter-image. Default: all.'),
