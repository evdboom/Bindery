...
const CONTENT = [
    ...
    "- **Cost awareness:** Full run is 4 readers + N authors per chapter batch (where N = size of the stored author panel, typically 2–3). Mention the total subagent count before starting, especially for whole-book runs or long chapters.",
